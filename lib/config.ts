...
export const UI_STRINGS: Record<Lang, {
  ...
  en: {
    ...
    metaTitle: '{profession} Salary in {city}: {salary} ({year})',
    metaDesc: 'A {profession} in {city} earns around {salary} per year. See salary range, cost of living, taxes, and quality of life index, updated {year}.',
  ...
  es: {
    ...
    metaTitle: 'Sueldo de {profession} en {city}: {salary} ({year})',
    metaDesc: 'Un/a {profession} en {city} gana alrededor de {salary} al año. Rango salarial, coste de vida, impuestos e índice de calidad de vida, actualizado {year}.',
  ...
  fr: {
    ...
    metaTitle: 'Salaire {profession} à {city} : {salary} ({year})',
    metaDesc: 'Un(e) {profession} à {city} gagne environ {salary} par an. Fourchette salariale, coût de la vie, impôts et indice de qualité de vie, mis à jour {year}.',
  ...
  pt: {
    ...
    metaTitle: 'Salário de {profession} em {city}: {salary} ({year})',
    metaDesc: 'Um(a) {profession} em {city} ganha cerca de {salary} por ano. Faixa salarial, custo de vida, impostos e índice de qualidade de vida, atualizado {year}.',
  ...
  de: {
    ...
    metaTitle: '{profession} Gehalt in {city}: {salary} ({year})',
    metaDesc: 'Ein/e {profession} in {city} verdient etwa {salary} pro Jahr. Gehaltsspanne, Lebenshaltungskosten, Steuern und Lebensqualitätsindex, aktualisiert {year}.',
  ...
  it: {
    ...
    metaTitle: 'Stipendio {profession} a {city}: {salary} ({year})',
    metaDesc: 'Un/a {profession} a {city} guadagna circa {salary} all\'anno. Fascia salariale, costo della vita, tasse e indice di qualità della vita, aggiornato {year}.',
  ...
  zh: {
    ...
    metaTitle: '{city}{profession}薪资{year}：{salary}',
    metaDesc: '{city}的{profession}年薪约为{salary}。薪资范围、生活成本、税率和生活质量指数（{year}年更新）。',
  ...
  ru: {
    ...
    metaTitle: 'Зарплата {profession} в {city}: {salary} ({year})',
    metaDesc: '{profession} в {city} зарабатывает около {salary} в год. Диапазон зарплат, стоимость жизни, налоги и индекс качества жизни, обновлено {year}.',
  ...
  ja: {
    ...
    metaTitle: '{city}の{profession}の給与{year}年：{salary}',
    metaDesc: '{city}の{profession}の年収は約{salary}です。給与範囲、生活費、税率、生活の質指数（{year}年更新）。',
  ...
  hi: {
    ...
    metaTitle: '{city} में {profession} वेतन {year}: {salary}',
    metaDesc: '{city} में {profession} सालाना लगभग {salary} कमाता है। वेतन सीमा, जीवन यापन लागत, कर और जीवन गुणवत्ता सूचकांक, {year} में अपडेट।',
...
// ─── CONVERSIÓN DE MONEDA (aprox., para metadata y UI) ────
export const CURRENCY_FX: Record<string, number> = {
